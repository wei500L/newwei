...
- 助手额度：`ASSISTANT_ORG_SUBMIT_LIMIT_PER_HOUR`、`ASSISTANT_ORG_MAX_IN_FLIGHT`、`ASSISTANT_ORG_MONTHLY_TOKEN_BUDGET`
...
```text
默认（legacy）：Web → api:4000（NestJS）
```

### 启用 pilot（api-go-pilot profile）
