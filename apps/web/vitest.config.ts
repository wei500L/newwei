  ...
  test: {
    ...
    coverage: {
      ...
      include: [
        ...
        "app/(app)/dashboard/charts/war-map/war-map-overlay-types.ts",
        "app/(app)/dashboard/charts/war-map/war-map-overlay-layout.ts",
        "app/(app)/dashboard/charts/war-map/war-map-overlay-view-model.ts",
        ...
        // FE-批5A：Crawl Task Detail 领域模块（root/实时/回填/结果/配置模型/展示域）
        "app/(app)/crawl/[taskId]/task-detail.tsx",
        "app/(app)/crawl/[taskId]/task-detail-types.ts",
        "app/(app)/crawl/[taskId]/task-detail-formatters.ts",
        "app/(app)/crawl/[taskId]/task-detail-config-core-model.ts",
        "app/(app)/crawl/[taskId]/task-detail-expansion-model.ts",
        "app/(app)/crawl/[taskId]/task-detail-markdown-model.ts",
        "app/(app)/crawl/[taskId]/task-detail-browser-model.ts",
        "app/(app)/crawl/[taskId]/task-detail-runtime-model.ts",
        "app/(app)/crawl/[taskId]/task-detail-multi-url-model.ts",
        "app/(app)/crawl/[taskId]/task-detail-link-model.ts",
        "app/(app)/crawl/[taskId]/task-detail-table-model.ts",
        "app/(app)/crawl/[taskId]/hooks/use-crawl-task-detail-query.ts",
        "app/(app)/crawl/[taskId]/hooks/use-crawl-task-ops-live.ts",
        "app/(app)/crawl/[taskId]/hooks/use-crawl-task-logs.ts",
        "app/(app)/crawl/[taskId]/hooks/use-crawl-task-actions.ts",
        "app/(app)/crawl/[taskId]/hooks/use-crawl-task-backfill.ts",
        "app/(app)/crawl/[taskId]/hooks/use-crawl-result-actions.ts",
        "app/(app)/crawl/[taskId]/task-detail-header.tsx",
        "app/(app)/crawl/[taskId]/task-detail-alerts.tsx",
        "app/(app)/crawl/[taskId]/task-detail-strategy-card.tsx",
        "app/(app)/crawl/[taskId]/task-detail-fields-section.tsx",
        "app/(app)/crawl/[taskId]/task-detail-expansion-section.tsx",
        "app/(app)/crawl/[taskId]/task-detail-browser-section.tsx",
        "app/(app)/crawl/[taskId]/task-detail-runtime-section.tsx",
        "app/(app)/crawl/[taskId]/task-detail-markdown-section.tsx",
        "app/(app)/crawl/[taskId]/task-detail-run-summary-section.tsx",
        "app/(app)/crawl/[taskId]/task-detail-task-logs.tsx",
        "app/(app)/crawl/[taskId]/task-detail-multi-url.tsx",
        "app/(app)/crawl/[taskId]/task-detail-link-overview.tsx",
        "app/(app)/crawl/[taskId]/task-detail-results.tsx",
        "app/(app)/crawl/[taskId]/task-detail-result-item.tsx",
        "app/(app)/crawl/[taskId]/task-detail-media-section.tsx",
        "app/(app)/crawl/[taskId]/task-detail-stored-media-section.tsx",
        "app/(app)/crawl/[taskId]/task-detail-tables-section.tsx",
      ],
