...
const DEFAULT_CLASSES: MarkdownVariantClasses = {
  ...
  blockquote: 'my-3 border-l-4 border-slate-300 dark:border-slate-600 pl-4 text-base italic text-slate-600 dark:text-slate-400',
  link: 'underline decoration-slate-300 underline-offset-2',
  mermaidWrapper: 'my-3 max-w-full overflow-auto rounded-lg border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 p-3',
  ...
  tableWrap: 'my-3 max-w-full overflow-auto rounded-lg border border-slate-200 dark:border-slate-700',
