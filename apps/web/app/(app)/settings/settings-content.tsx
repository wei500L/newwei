      ...
      <Form layout="vertical" form={form} onFinish={handleSubmit}>
        ...
        <Form.Item
          ...
          rules={[
            ...
            { type: "number", min: 500, max: 60_000, message: t("common.validation.numberRange", { min: 500, max: 60_000 }) }
          ]}
          extra={<NumberRangeExtra name="conditionalRequestTimeoutMs" min={500} max={60_000} unit="ms" />}
        >
          <UnitInputNumber min={500} max={60_000} step={100} unit="ms" disabled={!conditionalRequestEnabled} style={{ width: "100%" }} />
        </Form.Item>
        <Form.Item
          ...
          extra={<NumberRangeExtra name="conditionalRequestMaxRetries" min={0} max={5} />}
        >
          <InputNumber min={0} max={5} step={1} disabled={!conditionalRequestEnabled} style={{ width: "100%" }} />
        </Form.Item>
        <Form.Item
