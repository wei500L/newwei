export interface NewsSourceOpmlPreset {
  id: string;
  name: string;
  description: string;
...
const HN_POPULAR_BLOGS_2025_OPML = `
...
export const NEWS_SOURCE_OPML_PRESETS: NewsSourceOpmlPreset[] = [
  {
    id: 'hn_popular_blogs_2025',
    name: 'HN Popular Blogs 2025',
    description:
      'RSS/Atom feed list curated from HN Popularity Contest 2025 for direct import.',
    defaultLanguage: 'zh',
    opml: HN_POPULAR_BLOGS_2025_OPML,
  },
];

export const findNewsSourceOpmlPreset = (id: string) =>
  NEWS_SOURCE_OPML_PRESETS.find((preset) => preset.id === id) ?? null;
