...
export const WAR_MAP_HOTSPOTS: WarMapHotspot[] = [
  {
    ...
    level: "low",
    description:
      "Washington DC — US political center, White House, Pentagon, Capitol",
  },
  {
    id: "moscow",
    name: "Moscow",
  ...
  },
  {
    ...
    level: "high",
    description:
      "Caracas — Venezuela crisis, sanctions, humanitarian emergency",
  },
  {
    id: "nuuk",
    name: "Nuuk",
...
export const WAR_MAP_NUCLEAR_SITES: WarMapStrategicPoint[] = [
  {
    ...
    lat: 33.7,
    lng: 51.7,
    description: "Natanz — Iran uranium enrichment",
  },
  {
    id: "yongbyon",
    name: "Yongbyon",
  ...
  },
  {
    ...
    lat: 31.0,
    lng: 35.1,
    description: "Dimona — Israel nuclear facility",
  },
  {
    id: "bushehr",
    name: "Bushehr",
...
export const WAR_MAP_MILITARY_BASES: WarMapStrategicPoint[] = [
  ...
  },
  {
    ...
    lat: 13.5,
    lng: 144.8,
    description: "Guam — US Pacific Command, bomber base",
  },
  {
    id: "djibouti",
    name: "Djibouti",
