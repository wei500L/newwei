export const COUNTRY_DATA = [
  ...
  { name: "French Afar and Issas", alpha2: "AI", alpha3: "AFI" },
  ...
  { name: "Bosnia & Herzegovina", alpha2: "BA", alpha3: "BIH" },
  ...
  { name: "Czechoslovakia", alpha2: "CS", alpha3: "CSK" },
  { name: "Serbia and Montenegro", alpha2: "CS", alpha3: "SCG" },
  { name: "Canton and Enderbury Islands", alpha2: "CT", alpha3: "CTE" },
  ...
  { name: "German Democratic Republic", alpha2: "DD", alpha3: "DDR" },
  ...
  { name: "Dahomey", alpha2: "DY", alpha3: "DHY" },
  ...
  { name: "French Southern and Antarctic Territories", alpha2: "FQ", alpha3: "ATF" },
  ...
  { name: "Gilbert and Ellice Islands", alpha2: "GE", alpha3: "GEL" },
  ...
  { name: "Upper Volta", alpha2: "HV", alpha3: "HVO" },
  ...
  { name: "Johnston Island", alpha2: "JT", alpha3: "JTN" },
  ...
  { name: "Midway Islands", alpha2: "MI", alpha3: "MID" },
  ...
  { name: "New Hebrides", alpha2: "NH", alpha3: "NHB" },
  ...
  { name: "Dronning Maud Land", alpha2: "NQ", alpha3: "ATN" },
  { name: "Nauru", alpha2: "NR", alpha3: "NRU" },
  { name: "Neutral Zone", alpha2: "NT", alpha3: "NTZ" },
  ...
  { name: "Pacific Islands, Trust Territory of the", alpha2: "PC", alpha3: "PCI" },
  ...
  { name: "Palestinian Territory, Occupied", alpha2: "PS", alpha3: "PSE" },
  { name: "Portugal", alpha2: "PT", alpha3: "PRT" },
  { name: "U.S. Miscellaneous Pacific Islands", alpha2: "PU", alpha3: "PUS" },
  { name: "Palau", alpha2: "PW", alpha3: "PLW" },
  { name: "Paraguay", alpha2: "PY", alpha3: "PRY" },
  { name: "Panama Canal Zone", alpha2: "PZ", alpha3: "PCZ" },
  { name: "Qatar", alpha2: "QA", alpha3: "QAT" },
  { name: "Reunion", alpha2: "RE", alpha3: "REU" },
  { name: "Southern Rhodesia", alpha2: "RH", alpha3: "RHO" },
  ...
  { name: "Sikkim", alpha2: "SK", alpha3: "SKM" },
  ...
  { name: "Vatican City State", alpha2: "VA", alpha3: "VAT" },
  { name: "Saint Vincent And The Grenadines", alpha2: "VC", alpha3: "VCT" },
  { name: "Viet-Nam, Democratic Republic of", alpha2: "VD", alpha3: "VDR" },
